...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="<%=request.getContextPath()%>/auth/logout"><button class="btn  btn-success" type="submit">Log out</button></a>
        </div>
    </div>
</nav>
<%
...
<div class="container w-50 mb-4">
    <h3 class="mt-4">Registration | Create</h3>
    <form action="<%=request.getContextPath()%>/auth/registration" method="post">
        <div class="mb-3">
